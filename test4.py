...
class SignupWin(Frame):
    ...
    def __init__(self, window,controller):
        ...
        #===============Name====================
        self.name_label = Label(self.lgn_frame, text='Email', bg='#FFFFFF', font=('yu gothic ui', 16, 'bold'),
                                 fg='#000000')
        ...
        self.sign_button_label.place(x=785, y=575)
        ...
        self.sign.place(relx=0.15, rely=0.2)
